...
<!-- Fulfilled requirements discovered during exploration, planning, and implementation. -->

## Test cases added

### Frontend

<!-- One user-readable scenario per frontend test case added by the PR, or None. -->

### Backend

<!-- One user-readable scenario per backend test case added by the PR, or None. -->
