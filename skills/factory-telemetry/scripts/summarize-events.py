...
def render_summary(analysis: dict[str, Any], errors: list[str]) -> str:
    ...
    lines = [
        ...
        f"| Completed-run elapsed time (includes waits) | {format_duration(analysis['exact_active_ms'])} |",
        f"| Incomplete-run observed elapsed time | {format_duration(analysis['lower_bound_active_ms'])} |",
